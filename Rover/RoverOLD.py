...
#@app.route("/<reset>")
def reset():
		servo_set(LServoNum, "1500us", "servo")
		servo_set(RServoNum, "1500us", "servo")
...
def move(direction):
		...
		if direction == 'go':
			servo_set(LServoNum, "1510us", "servo")
			servo_set(RServoNum, "1499us", "servo")
			sleep(2)
			#print "Rover Go"
		elif direction == 'back':
			servo_set(LServoNum, "1499us", "servo")
			servo_set(RServoNum, "1510us", "servo")
			sleep(2)
			#print "Rover Back"
		elif direction == 'left':
			servo_set(LServoNum, "1510us", "servo")
